...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Progect = new Property(7, int.class, "progect", false, "PROGECT");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USERS\" (" + //
                ...
                "\"PROGECT\" INTEGER NOT NULL ," + // 7: progect
                "\"BIO\" TEXT);"); // 8: bio
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        stmt.bindLong(8, entity.getProgect());
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getInt(offset + 7), // progect
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setProgect(cursor.getInt(offset + 7));
